...
//********************************************************************************
				case 4: {
					...
					//	System.out.println(theTest.printAnswers(serial));
						...
						index = input.nextInt();
						while (index <= 0 || (index > (((AmericanQuestion)(theTest.getAllQuestions().get(serial))).getAnswer()).size())) {
					...
					//theTest.editAnswer(serial, newA, isCorrect, index-1);
...
//********************************************************************************
				case 6: {
					...
					File examFile = new File("C:\\project\\exams\\"+fileName);
