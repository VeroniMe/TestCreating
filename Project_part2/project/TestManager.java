...
//********************************************************************************
	...
	public void editQuestion(String newQ, int serial) {
		allQuestions.get(serial).setQuestion(newQ);
		
	}



	public void editAnswer(int serial, String newA, boolean isCorrect, int index) {
